...
plt.xlabel("Masa Inicial $\: M_{\\rm ZAMS}$ [M$_\\odot$]", fontsize=14)
plt.ylabel("Masa Final $\: M_{\\rm remnant}$ [M$_\\odot$]", fontsize=14)
plt.title("Relación Masa Inicial–Final (IFMR) (Kalirai+2008; Raithel+2018)", fontsize=15)
...
# Para visualizar la fracción de cada objeto:
...
# Para visualizar el tipo de objeto que resulta a partir de cada masa inicial y tiempo de evolución.
...
plt.xlabel("Masa inicial $\: M_{\\rm ZAMS}$ [M$_\\odot$]", fontsize=14)
plt.ylabel("Tiempo de Evolución $\: t_{\\rm evo}$ [Gyr]", fontsize=14)
plt.title("Relación Masa Inicial–Tiempo de Evolución", fontsize=15)
...
plt.xlabel("Masa inicial $\: M_{\\rm ZAMS}$ [M$_\\odot$]", fontsize=14)
plt.ylabel("Tiempo como Remanente $\: t_{\\rm dead}$ [Gyr]", fontsize=14)
plt.title("Relación Masa Inicial – Tiempo como Remanente", fontsize=15)
plt.grid(alpha=0.25)
...
plt.xlabel("Tiempo de Nacimiento $\: t_{\\rm birth}$ [Gyr]", fontsize=14)
plt.ylabel("Tiempo como Remanente $\: t_{\\rm dead}$ [Gyr]", fontsize=14)
plt.title("Relación Tiempo de Nacimiento–Tiempo como Remanente", fontsize=15)
...
plt.xlabel("Tiempo de Evolución $\: t_{\\rm evo}$ [Gyr]", fontsize=14)
plt.ylabel("Tiempo como Remanente $\: t_{\\rm dead}$ [Gyr]", fontsize=14)
plt.title("Relación Tiempo de Evolución-Tiempo como Remanente", fontsize=15)
